...
export class ToolBar extends React.Component<IToolBarProps> {
  ...
  private getToolButtons() {
    ...
    if (this.props.base_button) {
      button_list.push(
        <button id={"getHelp"} className={"helpButton"} type="button">
          Помощь
        </button>
      );
    }
    if (this.props.graph_manipulations_button) {
      button_list.push(
        <button id="addNodeButton" className={"toolButton"} type="button">
          Добавить вершину
        </button>
      );
      button_list.push(
        <button id="deleteNodeButton" className={"toolButton"} type="button">
          Удалить вершину
        </button>
      );
      button_list.push(
        <button id="concatNodeButton" className={"toolButton"} type="button">
          Соединить вершины
        </button>
      );
      button_list.push(
        <button id="deleteEdgeButton" className={"toolButton"} type="button">
          Удалить ребро
        </button>
      );
    }
    if (this.props.graph_coloring_buttons) {
      ...
      button_list.push(
        <button id="recolorNodeButton" className={"toolButton"} type="button">
          Раскрасить вершину
        </button>
      );
      button_list.push(
        <button id="recolorEdgeButton" className={"toolButton"} type="button">
          Раскрасить ребро
        </button>
      );
    }
    if (this.props.graph_adj_coloring_buttons) {
      button_list.push(
        <button id="colorAdjNodeButton" className={"toolButton"} type="button">
          Выделить смежные вершины
        </button>
      );
      button_list.push(
        <button id="colorAdjEdgeButton" className={"toolButton"} type="button">
          Выделить смежные рёбра
        </button>
      );
      button_list.push(
        <button id="uncolorNodeButton" className={"toolButton"} type="button">
          Убрать выделение
        </button>
      );
    }
    if (this.props.graph_naming_buttons) {
      button_list.push(
        <button id="setNodeName" className={"toolButton"} type="button">
    ...
    if (this.props.graph_weight_buttons) {
      button_list.push(
        <button id="setEdgeWeight" className={"toolButton"} type="button">
          Назначить вес дуге
        </button>
      );
    }
